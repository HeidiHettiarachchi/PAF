    ...
    <div className="post-creator">
      ...
      <div className="creator-wrapper">
        <div className='continSection'>
          ...
          <div className="from_continer modern-card">
            <h1>Update Learning Plan</h1>
            <div className="gradient-divider"></div>
            <p className="header-caption">Refine your learning journey</p>

            <form onSubmit={handleSubmit} className='from_data modern-form'>
              <div className="Auth_formGroup input-container">
