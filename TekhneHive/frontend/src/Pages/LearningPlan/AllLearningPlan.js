...
import './post.css';
import '../PostManagement/AllPost.css'; // Add this import
...
function AllLearningPlan() {
  ...
  useEffect(() => {
    ...
    fetchPosts();
  }, []); // Ensure this runs only once on component 
      ...
      <div className="content-wrapper">
        <div className="search-section" style={{ marginTop: '40px' }}>
          <input
            ...
            placeholder="Search posts by owner name"
          ...
          >
            <IoIosCreate /> Create Learning Plan
          </button>
        </div>
